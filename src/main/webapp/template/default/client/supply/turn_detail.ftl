	    ...
	    <div class="view-logistics submit-orders">
	        ...
	        <div class="progressitem">
	            <div class="progressinfo">
	                ...
	                <#if ship.status==1><a href="javascript:;" class="a-pay" onclick="agreeReturn(${ship.id!''})">同意退货</a><a href="javascript:;" onclick="refuseReturn(${ship.id!''})" class="a-pay">不同意退货</a></#if>
            		<#if ship.status==4><a href="javascript:;" class="a-pay" onclick="completeReturn(${ship.id!''})">完成退货</a></#if>
	            </div>
	            <div class="progress">
	            <#if ship.status==1>
	            <textarea name="remark" id="remark" placeholder="请在这里输入拒绝理由" style="width:600px;height:80px"></textarea>
	            </#if>
	            </div>
	        </div>
	        <!-- 订单信息 -->
