...
<li>
	  <a href="<#if col.product??>${app.basePath}/product/item${col.product.id!''}<#else>javascript:;</#if>" title="" class="goods_a">
	  ...
	  <div class="l_addshop" style="display: none;">
	    <a href="javascript:;" title="" class="a2 fr" onclick="delCollect(${col.id?c});">删除</a>
	  </div>
