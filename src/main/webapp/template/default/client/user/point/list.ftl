    ...
    <div class="personal-center">
        ...
        <div class="right-content get_reward">
            ...
            <div class="my_wallet white_box">
                <div class="otitle">
                    <label for="" class="lab1 fl">我的积分</label>
                </div>
                <div class="clear"></div>
                <div class="sbox">
                    <section class="fl sec1">
                        <p class="p1">积分</p>
                        <p class="p2">${integral.integral!'0'}</p>
                    </section>
                    <section class="fr sec2"><a href="${app.basePath}/product/point/list" title="" class="">积分兑换</a></section>
                </div>
            </div>
            <!-- 我的钱包-结束 -->
            <!-- 明细 -->
