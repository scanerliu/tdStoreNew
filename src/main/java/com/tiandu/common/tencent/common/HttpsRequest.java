...
import com.tiandu.common.tencent.service.IServiceRequest;
...
public class HttpsRequest implements IServiceRequest{
    ...
    public String sendPostWithJson(String url, String jsonStr) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException
    {
        requestConfig = RequestConfig.custom().setSocketTimeout(socketTimeout).setConnectTimeout(connectTimeout).build();
        String result = null;
